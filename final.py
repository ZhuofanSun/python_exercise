...
class Alien:
    ...
    def __init__(self, x, y, width, height, color, surface):
        ...
        # - width of type int and
        # - height of type int are the dimensions of an alien ship
        # - color of type str is the color of an alien ship
        # - surface of type pygame.Surface
        self.color = color
        self.speed = 1
        self.surface = surface
    ...
    def draw(self):
        ...
        pygame.draw.ellipse(self.surface, pygame.Color(self.color), self.rect)
